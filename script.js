...
app.listen(host.port, async()=>{
    ...
    (async () => {
       ...
       const browserSetup = {
            ...
            args: [
                "--start-maximized",
                "--user-data-dir=" + uopts.chrome_path
            ],
       ...
       // console.log(chalk.blue("\nLancement du scraping ... \n"))
        ...
        function checkUserData(){
            ...
            if (sys.opsys == "darwin") {
                sys.chrome_path = "~/Library/Application Support/Google/Chrome"
            } else if (sys.opsys == "win32" || sys.opsys == "win64") {
                sys.chrome_path = sys.datadir + "\\AppData\\Local\\Google\\Chrome\\User Data";
            } else if (sys.opsys == "linux") {
                sys.chrome_path = "~/.config/google-chrome";
            }
        ...
        async function setCssAndJs(pf){
            ...
            await pf.addScriptTag({path: `public/assets/jquery-3.2.1.min.js`})
